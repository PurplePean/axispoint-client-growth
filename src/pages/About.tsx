...
export default function About() {
  ...
  const team = [
    ...
    },
    {
      ...
      bio: "Ethaniel serves as our licensed broker partner, handling all transaction execution and leasing activities. With 5 years of market experience, he ensures compliant and optimized deal execution.",
      credentials: ["TREC License"],
      contact: "Ethaniel@AxisPoint.LLC",
      icon: Award
    }
  ];
