...
export default function About() {
  ...
  return (
    <>
      <Helmet>
        <title>About AxisPoint | Experienced Commercial Real Estate Leaders</title>
        <meta 
          name="description" 
          content="Meet the AxisPoint team. Experienced professionals committed to delivering institutional-grade asset management for commercial real estate clients." 
        />
